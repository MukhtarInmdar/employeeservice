...
@Provider
public class DefaultBankerExceptionHandler implements ExceptionMapper<DefaultBankerException>{
	
	private final static Logger logger = Logger.getLogger(DefaultBankerExceptionHandler.class);
     ...
     */
	@Override
	public Response toResponse(DefaultBankerException exception) {
